...
class RejectCongeNotification extends Notification
{
    use Queueable;
    public $demandeConge;
    /**
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('Hello,')
            ->line('Your leave request has been rejected. Please proceed to the secretariat for more information about the rejection.')
            ->line('Leave details:')
