...
final class Path
{
     ...
     *
     * ```php
     * echo Path::canonicalize("\symfony\puli\..\css\style.scss");
     * // => /symfony/css/style.scss
     *
     * echo Path::canonicalize("../css/./style.scss");
     * // => ../css/style.scss
     * ```
     *
     ...
     *
     * ```php
     * echo Path::makeAbsolute("../style.scss", "/symfony/puli/css");
     * // => /symfony/puli/style.scss
     * ```
     *
     ...
     *
     * ```php
     * Path::makeAbsolute("/style.scss", "/symfony/puli/css");
     * // => /style.scss
     *
     * Path::makeAbsolute("C:/style.scss", "C:/symfony/puli/css");
     * // => C:/style.scss
     *
     * Path::makeAbsolute("C:/style.scss", "/symfony/puli/css");
     ...
     *
     * ```php
     * echo Path::makeRelative("/symfony/style.scss", "/symfony/puli");
     * // => ../style.scss
     * ```
     *
     ...
     *
     * ```php
     * Path::makeRelative("style.scss", "/symfony/puli/css");
     * // => style.scss
     * ```
     *
     ...
     *
     * ```php
     * Path::makeRelative("C:/symfony/style.scss", "/symfony/puli");
     * // InvalidArgumentException
     * ```
     *
     ...
     *
     * ```php
     * Path::makeRelative("/symfony/style.scss", "symfony/puli");
     * // InvalidArgumentException
     * ```
     *
     * If the base path is not an absolute path, an exception is thrown.
